...
export default function AdvertisingPage() {
  return (
    <div className="container">
      ...
      <PageHeader
        title="Реклама"
        lead="Правила простые: реклама помечена как реклама, а страницы платных тарифов от неё свободны."
      />

      <div className="prose" style={{ paddingBottom: 'var(--sp-16)' }}>
        <h2>Где показывается реклама</h2>
        <ul>
          <li>На страницах бесплатных профилей — рекламный блок с пометкой «Реклама».</li>
          <li>В редакционных разделах — партнёрские материалы с явной пометкой.</li>
        </ul>
        <p>
          На страницах платных тарифов сторонней рекламы нет. Клиент платит за свою
          страницу и не должен видеть на ней чужие объявления.
        </p>
