...
export const metadata: Metadata = {
  title: 'Разместить биографию о себе в интернете',
  description:
    'Как разместить официальную биографию о себе в интернете: страница в справочнике «Персонотека» от 7 500 ₽, этапы работы, редакционные требования и форма заявки.',
...
export default function PlacementPage() {
  ...
  return (
    <div className="container">
      ...
      {/* Ответ на вопрос «что и почём» — до объяснений. Фокус-группа
          12.09.2026: заказчик приходит по объявлению с ценой и на первом
          экране видел «Зачем это нужно»; цена и кнопка были на втором. */}
      <section className="section" aria-label="Коротко">
        <div className={styles.offer}>
          <p className={styles.offerPrice}>
            <strong>7 500 ₽</strong> разово и бессрочно. Редактор проверяет факты по источникам и
            ставит подпись; страница выходит за 9–16 рабочих дней.
          </p>
          <p className={styles.offerActions}>
            <a className={styles.offerBtn} href="#zayavka">
              Оставить заявку
            </a>
            {examples.length > 0 && (
              <Link className={styles.offerBtnSecondary} href={`/${examples[0].slug}/`}>
                Пример страницы
              </Link>
            )}
          </p>
      ...
      <section className="section">
        ...
        <div className={styles.faq}>
          <details>
            <summary>Сколько стоит разместить биографию о себе?</summary>
            <p>
              Страница в каталоге — 7 500 ₽, разово и бессрочно: без продлений и
              абонентской платы. Досье под ключ с поиском источников — по расчёту.
              Состав тарифов — в таблице выше и на странице{' '}
              <Link href="/tarify/">тарифов</Link>.
            </p>
          </details>
          <details>
            <summary>В выдаче по моему имени есть старое судебное дело. Что с ним будет?</summary>
            <p>
              Судимость, здоровье и другие специальные категории данных на страницу не
              попадают без вашего отдельного письменного согласия — так записано в{' '}
              <Link href="/redpolitika/">редакционной политике</Link>. Чужие ссылки из
              выдачи страница не удаляет: она даёт первый достоверный источник о вас,
              на который можно сослаться, и со временем занимает место рядом с ними.
              Если нужно именно удаление, это другая процедура — <Link href="/udalenie-dannyh/">форма
              запроса на удаление</Link>.
            </p>
          </details>
          <details>
            <summary>Чем это отличается от статьи в Википедии?</summary>
            <p>
              Википедия требует формальной значимости — независимых публикаций о вас —
              и удаляет статьи, написанные о себе. Здесь страницу готовит редакция по
              документам и открытым источникам, требований к известности нет, а факты
              и дата обновления проверяемы. Подробнее —{' '}
              <Link href="/kak-eto-rabotaet/pochemu-nelzya-napisat-o-sebe-v-vikipedii/">
                почему нельзя написать о себе в Википедии
              </Link>
              .
            </p>
          </details>
      ...
      <section className="section" id="zayavka">
        ...
        <p className={styles.legalNote}>
          ...
          Ответим с рабочей почты редакции в ближайший рабочий день.
        </p>
      </section>
    </div>
  )
