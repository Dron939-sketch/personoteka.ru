...
const PAIRS: Pair[] = [
  ...
  { fg: '--cool-600', bg: '--surface', purpose: 'числа на карточке', min: 4.5 },
  { fg: '--cool-600', bg: '--cool-50', purpose: 'числа в секции с данными', min: 4.5 },
  { fg: '--cool-600', bg: '--cool-100', purpose: 'числа на шапке таблицы', min: 4.5 },
  { fg: '--ink', bg: '--cool-50', purpose: 'текст в секции с данными', min: 4.5 },
  { fg: '--ink-2', bg: '--cool-50', purpose: 'вторичный текст в секции с данными', min: 4.5 },
  { fg: '--ink-3', bg: '--cool-50', purpose: 'подписи в секции с данными', min: 4.5 },
  { fg: '--ink-2', bg: '--cool-100', purpose: 'шапка таблицы рейтинга', min: 4.5 },
  { fg: '--accent-700', bg: '--cool-50', purpose: 'ссылки в секции с данными', min: 4.5 },
  { fg: '--cool-300', bg: '--cool-50', purpose: 'холодная линейка (не текст)', min: 1.2 },
